...
Public Class Inf_Test
    ...
    Public Function LoadCSV() As String()
        ...
        Dim line(TestMenu.TotalQty - 1) As String
    ...
    Public Sub NextQuestion()
        ...
        PrintLine(1, Result_Form.QuestionNum, QuestionSeed, AnswerSeed(0), AnswerSeed(1), AnswerSeed(2), AnswerSeed(3), AnswerSeed(4), RandomType(0), RandomType(1))
